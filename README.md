...
Modo silencioso: Escaneo automatizado sin interacción, solo reporta anomalías.
...
```bash
git clone https://github.com/tu-usuario/pud-shield.git
cd pud-shield
```
...
PUD-Shield está diseñado exclusivamente para uso en **sistemas propios** o en sistemas donde tienes **autorización explícita**. El uso de esta herramienta en sistemas ajenos sin permiso puede ser ilegal. El autor no se responsabiliza del mal uso de la herramienta.
